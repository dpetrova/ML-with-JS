...
//run analysis by different k values:
//document.querySelector('button#analyze').addEventListener('click', runAnalysisByDifferentK);

//run analysis by individual feature:
document
  .querySelector("button#analyze")
  .addEventListener("click", runAnalysisByIndividualFeature);
